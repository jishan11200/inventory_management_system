                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="javascript:void(0)" onclick="document.getElementById('logout-form').submit();"><i class="md md-settings-power"></i> Logout</a></li>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="fa fa-users"></i> Employee </span><span class="pull-right"><i class="md md-add"></i></span></a>
