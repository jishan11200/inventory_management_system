                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <a href="{{ route('add.customer') }}" class="btn btn-sn btn-info pull-right">Add New Customer</a>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ URL::to('delete-customer/'.$customer->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a>
